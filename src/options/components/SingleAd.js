            ...
            <div className='post-image-container'>
                ...
                <div className='footer-container'>
                    <div className='footer-domain-text-container'>
                        <span className='footer-domain'>{ad?.['action_links']?.['link_display']}</span>
                        <span className='footer-text-title'>{ad?.['action_links']?.['link_title']}</span>
                        <span className='footer-text'>{ad?.['action_links']?.['link_description']}</span>
                    </div>
                    <div className='footer-button-container'>
                        <a href={ad?.['action_links']?.['url']}>{ad?.['action_links']?.['link_type']}</a>
                    </div>
                </div>
            </div>
